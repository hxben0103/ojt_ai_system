...
class AuthService {
  ...
  static Future<void> logout() async {
    try {
      // Clear per-user cache before removing credentials
      final user = await getCurrentUser();
      if (user?.userId != null) {
        await CacheService.clearForUser(user!.userId!);
      }
      final prefs = await SharedPreferences.getInstance();
      await prefs.remove(_tokenKey);
      await prefs.remove(_userKey);
    } catch (e) {
      debugPrint('Warning: Could not clear SharedPreferences: $e');
    }
  ...
  static Future<User?> getCurrentUser() async {
    try {
      try {
        ...
        debugPrint('Warning: Could not read from SharedPreferences: $e');
      }
  ...
  static Future<String?> getToken() async {
    try {
      ...
      debugPrint('Warning: Could not read token from SharedPreferences: $e');
      return null;
    }
  }
  ...
  static Future<void> _saveToken(String token) async {
    try {
      ...
      debugPrint('Warning: Could not save token to SharedPreferences: $e');
    }
  }
  ...
  static Future<void> _saveUser(Map<String, dynamic> user) async {
    try {
      ...
      // On web, SharedPreferences might fail
      debugPrint('Warning: Could not save user to SharedPreferences: $e');
    }
  }
